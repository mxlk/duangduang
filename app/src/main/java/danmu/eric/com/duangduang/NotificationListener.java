...
import danmu.eric.com.duangduang.biz.DrawBarrage;
...
public class NotificationListener extends NotificationListenerService {
    ...
    private DrawBarrage barrageView;
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        ...
        if(barrageView == null){
            barrageView = new DrawBarrage(NotificationListener.this);
            barrageView.setAddRemoveCallBack(new DrawBarrage.AddRemoveCallBack() {
                @Override
